 ...
 */
@Local
public interface ServicioImportacionCURusCanarias
{
	@Remove
	public void destroy();
	...
	/**
	 * Modifica el valor de la propiedad 'sheetListItems'
	 * 
	 ...
	 * 
	 * @param selectedSheet valor de tipo int[]
	 */
	public void setSelectedSheet(int[] selectedSheet);
	
	/**
	 * Método que se encarga de importar condiciones urbanísticas apartir
