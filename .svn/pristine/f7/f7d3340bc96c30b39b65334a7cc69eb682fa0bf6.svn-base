...
@Stateful
@Name("gestionArbolOperacionesDeterminaciones")
public class GestionArbolOperacionesDeterminacionesBean extends GestionArbolGenerico
		implements Serializable, GestionArbolOperacionesDeterminaciones {
	@Logger
	private Log log;
	...
	public void nodeSelected(ActionEvent event) {
		...
		{
			// Como es el nodo raiz, pongo la determinacion a cero
