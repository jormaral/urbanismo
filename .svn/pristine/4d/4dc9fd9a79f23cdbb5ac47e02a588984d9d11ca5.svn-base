...
@Name("seleccionarListaGruposAplicacionTramite")
public class SeleccionarListaGruposAplicacionTramiteBean  implements SeleccionarListaGruposAplicacionTramite {
