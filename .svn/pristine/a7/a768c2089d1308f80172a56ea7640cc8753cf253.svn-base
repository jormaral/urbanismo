...
@Local
public interface ListaDeterminacionesReguladorasTramite extends SortableListIF
{
	 ...
	 * 
	 * @return valor de tipo List<DeterminacionReguladoraTramiteDTO>
	 */
	...
	/**
	 * Modifica el valor de la propiedad '@param idTipoTramiteTrabajoDR'
	 * 
	 * @param idTipoTramiteTrabajoDR valor de tipo 
	 */
