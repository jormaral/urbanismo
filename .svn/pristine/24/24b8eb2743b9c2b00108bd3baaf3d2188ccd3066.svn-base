 ...
 *
 */
@Stateless(name = "refundido.operacion.entidades.acumulacionUsos")
public class AcumulacionUsos extends CopiarEntidadDeterminacion implements EjecutorLocal {

	private static List<Integer> CARACTERES = Arrays.asList(ClsDatos.ID_CARACTER_USO, ClsDatos.ID_CARACTER_GRUPODEUSOS);
	...
	public void ejecutar(int idOperada, int idOperadora,
		...
		contexto.logTraducido(LOG.INFO, "refundido.operacion.entidad.acumulacionUsos.mensaje", 
