 ...
 *
 */
@Stateless ( name = "refundido.operacion.entidades.suspensionTotal")
public class SuspensionTotal implements EjecutorLocal {
	...
	public void ejecutar(int idOperada, int idOperadora,
		...
		contexto.logTraducido(LOG.INFO, "refundido.operacion.entidad.suspensionTotal.mensaje", 
