 ...
 *
 */
@Stateless(name = "DEL_DETERMINACION_REGIMEN_ACTO")
public class BorrarRegimenActo implements IAccion {
    ...
    public void ejecutar(HttpServletRequest request,
        ...
        try {
            response.getWriter().print(servicioFichas.delDeterminacionRegimenActo( Long.parseLong(request.getParameter("idElemento"))));
