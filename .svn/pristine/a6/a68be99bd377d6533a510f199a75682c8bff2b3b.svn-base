 ...
 *
 */
@Stateless(name = "refundido.operacion.planes.levantamiento")
public class RevocacionSuspensionTotal implements EjecutorLocal {
	...
	public void ejecutar(int idOperado, int idOperador,
		...
		contexto.logTraducido(LOG.INFO, "refundido.operacion.plan.levantamiento.mensaje", operado.getCodigo(), operador.getCodigo());		
	}
