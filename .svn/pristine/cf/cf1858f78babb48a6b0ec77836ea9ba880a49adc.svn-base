...
@Entity
@Name("regimenesEspecificosSimplificadosUsoActos")
@Table(name="regimenesespecificossimplificadosusoactos", schema = "gestionfip")
@SequenceGenerator( name = "DETSEQ", sequenceName = "gestionfip.gestionfip_regimenesespecificossimplificadosusosactos_id_seq",allocationSize=1 )
public class RegimenesEspecificosSimplificadosUsoActos implements Serializable{
	...
	public RegimenesEspecificosSimplificadosUsoActos() {
		super();
		
	}


	public RegimenesEspecificosSimplificadosUsoActos(String nombreRegimenEspecifico,
