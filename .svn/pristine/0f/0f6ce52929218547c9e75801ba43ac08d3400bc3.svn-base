 ...
 *
 */
@Stateless(name = "DEL_CAPA_FICHA")
public class BorrarConjuntoFicha implements IAccion {
    ...
    public void ejecutar(HttpServletRequest request,
        ...
        try {
            response.getWriter().print(servicioFichas.delConjunto( Long.parseLong(request.getParameter("idElemento"))));
