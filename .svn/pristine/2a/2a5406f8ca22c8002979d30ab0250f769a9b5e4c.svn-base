 ...
 *
 */
@Stateless(name="InstrumentoTipoOperacion")
public class InstrumentoTipoOperacionHelper implements IJsonHelper {
	...
	public Map<String, Object> marshal(Object id, String idioma) {
		...
		for (Instrumentotipooperacionplan instrumento : servicioDiccionario.get(Instrumentotipooperacionplan.class)) {
			res = new HashMap<String, Object>();
			res.put("iden", instrumento.getIden());
			res.put("tipooperacionplan", instrumento.getTipooperacionplan().getIden());
	        res.put("instrumentoplan", instrumento.getInstrumentoplan().getIden());
