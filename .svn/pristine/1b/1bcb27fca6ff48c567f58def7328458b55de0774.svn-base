...
@Stateful
@Name("gestionArbolEntidadesDocumento")
public class GestionArbolEntidadesDocumentoBean extends GestionArbolGenerico
		implements Serializable, GestionArbolEntidadesDocumento {
	@Logger
	private Log log;
