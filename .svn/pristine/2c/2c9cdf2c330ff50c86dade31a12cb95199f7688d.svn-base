 ...
 *
 */
@Stateless(name = "GUARDAR_DETERMINACION_GRUPO_DET")
public class GuardarDeterminacionGrupoDet implements IAccion {
    ...
    public void ejecutar(HttpServletRequest request,
        ...
        try {
            Grupodeterminaciondeterminacion grupo = null;

            grupo = servicioFichas.guardarGrupoDeterminacionDeterminacion(
                    ...
                    Boolean.getBoolean(request.getParameter("regEsp")));
