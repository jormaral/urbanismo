...
@Stateful
@Name("gestionArbolDeterminacionesDocumento")
public class GestionArbolDeterminacionesDocumentoBean extends GestionArbolGenerico
		implements Serializable, GestionArbolDeterminacionesDocumento {
	@Logger
	private Log log;
