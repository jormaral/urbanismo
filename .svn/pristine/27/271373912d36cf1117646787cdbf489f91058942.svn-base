...
public class Vinculocaso  implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1816596149084861636L;
	private int iden;
    ...
    public Vinculocaso(int iden, Casoentidaddeterminacion casoentidaddeterminacionByIdcasovinculado, Casoentidaddeterminacion casoentidaddeterminacionByIdcaso) {
       this.iden = iden;
    ...
    public void setCasoentidaddeterminacionByIdcasovinculado(Casoentidaddeterminacion casoentidaddeterminacionByIdcasovinculado) {
        this.casoentidaddeterminacionByIdcasovinculado = casoentidaddeterminacionByIdcasovinculado;
    }
