 ...
 *
 */
@Stateless(name="DeterminacionEsOperadoPor")
public class DeterminacionEsOperadoPor implements IJsonHelper {
	...
	public Map<String, Object> marshal(Object id, String idioma) {
		...
		for (Operaciondeterminacion od : servicioPlaneamiento.getOperacionesPorDeterminacionOperada((Integer)id)) {
			elemento = new HashMap<String, Object>();
			elemento.put("iden", od.getIden());
			elemento.put("determ", od.getDeterminacionByIddeterminacionoperadora().getApartado() + " " + od.getDeterminacionByIddeterminacionoperadora().getNombre());
			elemento.put("tipo", servicioDiccionario.getTraduccion(Tipooperaciondeterminacion.class, od.getIdtipooperaciondet(), idioma));
			elemento.put("plan", od.getDeterminacionByIddeterminacionoperadora().getTramite().getPlan().getNombre());
			elemento.put("regimen", od.getOperacion().getTexto());
			elemento.put("codigo", od.getDeterminacionByIddeterminacionoperadora().getCodigo());
			
			instrumento = servicioDiccionario.getInstrumento(od.getDeterminacionByIddeterminacionoperadora().getTramite().getPlan().getIden());
