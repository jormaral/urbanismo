 ...
 *
 */
@Stateless(name="regulacion")
public class RegulacionHelper extends AbstractDeterminacionHelper implements IJsonHelper {
	...
	public Map<String, Object> marshal(Object id, String idioma) {
		...
		Determinacion[] determinaciones = servicioPlaneamiento.getDeterminacionesReguladoras(Integer.parseInt(id.toString()));
		for (Determinacion determinacion : determinaciones) {
			listaDets.add(procesarDeterminacion(determinacion, 
					servicioPlaneamiento.getUnidad(determinacion.getIden()), 
