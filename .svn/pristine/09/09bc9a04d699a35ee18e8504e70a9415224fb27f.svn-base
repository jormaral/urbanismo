 ...
 *
 */
@Stateless(name = "DEL_GRUPO_DETERMINACION_FICHA")
public class BorrarConjuntoDeterminacion implements IAccion {
    ...
    public void ejecutar(HttpServletRequest request,
        ...
        try {
            response.getWriter().print(servicioFichas.delGrupoDeterminacion( Long.parseLong(request.getParameter("idElemento"))));
