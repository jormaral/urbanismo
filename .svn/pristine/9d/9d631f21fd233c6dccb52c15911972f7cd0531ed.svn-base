 ...
 *
 */
@Stateless ( name = "refundido.operacion.entidades.superposicionUsos")
public class SuperposicionUsos extends CopiarEntidadDeterminacion implements EjecutorLocal {
	private static final List<Integer> CARACTERES = Arrays.asList(ClsDatos.ID_CARACTER_USO, ClsDatos.ID_CARACTER_GRUPODEUSOS);
	...
	public void ejecutar(int idOperada, int idOperadora,
		...
		contexto.logTraducido(LOG.INFO, "refundido.operacion.entidad.superposicionUsos.mensaje", 
