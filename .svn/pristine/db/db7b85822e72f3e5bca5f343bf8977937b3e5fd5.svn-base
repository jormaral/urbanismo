 ...
 *
 */
@Stateless(name = "DEL_DETERMINACION_CLASIF_USO")
public class BorrarDetClasifUso implements IAccion {
    ...
    public void ejecutar(HttpServletRequest request,
        ...
        try {
            response.getWriter().print(servicioFichas.delDeterminacionClasificatoriaUso( Long.parseLong(request.getParameter("idElemento"))));
