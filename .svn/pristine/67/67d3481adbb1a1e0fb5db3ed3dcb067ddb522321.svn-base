...
public class Documentocaso  implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 9010375221487804121L;
	private int iden;
    ...
    public Documentocaso(int iden, Documento documento, Casoentidaddeterminacion casoentidaddeterminacion) {
       this.iden = iden;
    ...
    public void setCasoentidaddeterminacion(Casoentidaddeterminacion casoentidaddeterminacion) {
        this.casoentidaddeterminacion = casoentidaddeterminacion;
    }
