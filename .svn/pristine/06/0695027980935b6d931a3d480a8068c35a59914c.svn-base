...
@Stateful
@Name("gestionArbolOperacionesDeterminacionesOperadoras")
public class GestionArbolOperacionesDeterminacionesOperadorasBean extends GestionArbolGenerico implements Serializable, GestionArbolOperacionesDeterminacionesOperadoras
{
    /**
	 * 
	 */
