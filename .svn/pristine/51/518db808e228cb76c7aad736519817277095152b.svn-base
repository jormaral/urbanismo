...
@Stateful
@Name("gestionArbolEntidades")
public class GestionArbolEntidadesBean extends GestionArbolGenerico implements Serializable, GestionArbolEntidades
{
    /**
	 * 
	 */
    ...
    @In (create = true, required = false)
    ListaCUSimplificada listaCUSimplificada;
