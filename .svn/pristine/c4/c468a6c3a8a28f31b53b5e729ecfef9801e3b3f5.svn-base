...
public class Entidadpol  implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4989722457392391063L;
	private int iden;
    ...
    public Entidadpol(int iden, Entidad entidad, int objectid) {
        this.iden = iden;
        this.entidad = entidad;

    }
    public Entidadpol(int iden, Entidad entidad, int objectid, Integer shape, String geom) {
       this.iden = iden;
       this.entidad = entidad;
       this.geom = geom;
    }
