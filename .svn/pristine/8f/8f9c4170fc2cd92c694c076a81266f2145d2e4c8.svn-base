 ...
 *
 */
@Stateless(name="determinacion")
public class DeterminacionHelper extends AbstractDeterminacionHelper implements IJsonHelper {
	...
	public Map<String, Object> marshal(Object id, String idioma) {
		...
		Determinacion det = servicioPlaneamiento.get(Determinacion.class, id);
		
		if (det != null) {
			listaDets.add(procesarDeterminacion(det, servicioPlaneamiento.getUnidad((Integer)id), servicioDiccionario, idioma));
		}
