 ...
 *
 */
@Stateless(name="GET_NODOS_ENTIDAD_DE_TRAMITE")
public class GetEntidadesRaiz implements IAccion {
	...
	public void ejecutar(HttpServletRequest request,
		...
		if (idTramite != null) {
			Entidad[] entidades = servicioPlaneamiento.getEntidadesRaiz(Integer.valueOf(idTramite));
