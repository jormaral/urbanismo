...
/**
 * interfaz que define la funcionalidad requerida de validación para la
 * consola de validación. 
 * 
 * Esta interfaz permite definir un mediador que sirva de punto de acceso a
 * entidades externas reduciendo el acoplamiento con el resto de EJBs.
 * 
 * @author Arnaiz Consultores
 *
 */
@Local
public interface ValidacionFipLocal {
     ...
     * 
     * @param proceso Identificador del proceso sobre el que se genera el informe.
