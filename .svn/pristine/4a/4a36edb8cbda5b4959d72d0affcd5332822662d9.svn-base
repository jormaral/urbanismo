 ...
 *
 */
@Stateless(name="AplicacionesDeDet")
public class AplicacionesDeDetHelper extends AbstractEntidadHelper implements IJsonHelper {
	...
	public Map<String, Object> marshal(Object id, String idioma) {
		...
		for (Entidad entidad : servicioPlaneamiento.getAplicacionesDeterminacion((Integer)id)) {
