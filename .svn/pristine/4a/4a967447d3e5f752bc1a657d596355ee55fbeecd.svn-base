...
public class DeterminacionReguladoraTramiteDTO {
	...
	public DeterminacionReguladoraTramiteDTO() {

	}
	
	

	public DeterminacionReguladoraTramiteDTO(int idDeterminacion, String ordenArbol,
