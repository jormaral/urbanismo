...
@Stateful
@Name("gestionArbolOperacionesEntidadesOperadoras")
public class GestionArbolOperacionesEntidadesOperadorasBean extends GestionArbolGenerico implements Serializable, GestionArbolOperacionesEntidadesOperadoras
{
    /**
	 * 
	 */
    ...
    private int idEntidadSeleccionada = 0;
	...
	public void nodeSelected(ActionEvent event) {
        ...
        if (!node.isRoot())
        {
            ...
            idEntidadSeleccionada = idEntidadBD;
           
            
            log.info("[nodeSelected] Se ha guardado la variable idEntidadSeleccionada " +idEntidadBD );
	...
	public void cargarArbolInicial() {
			...
			if (idTramiteTrabajoArbol==0)
			{
				...
				log.debug("[inicializarLista] Si es cero lo inicializo al plan encargado: idTramiteTrabajoArbol="+idTramiteTrabajoArbol);
			}
    ...
    public int getIdEntidadSeleccionada() {
