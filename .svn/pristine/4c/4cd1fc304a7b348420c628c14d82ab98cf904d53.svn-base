 ...
 * de entidades a documentos.
 * 
 * @author fguerero
 *
 */
@Local
public interface ListaEntidadesDocumento extends SortableListIF
{
	/**
     * Obtiene la lista completa de entidades asociadas al
     * un documento, obteniendo el ID del documento actual de trabajo
     * del bean VariablesSesionGenerales.
     * 
     * @return lista de objetos de tipo EntidadDTO
     */
	...
	/**
	 * Ordena y refresca la lista actual.
	 * 
	 */
	public void sort();
