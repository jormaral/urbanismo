...
@Stateful
@Name("gestionArbolValidacionTramite")
public class GestionArbolValidacionTramiteBean extends GestionArbolGenerico implements Serializable, GestionArbolValidacionnTramite
{
	...
	public void cargarArbolInicial() {
	 ...
	 public void processValueChange(ValueChangeEvent e) {
	 		...
	 		PanelTabSet panelt = (PanelTabSet)uiView.findComponent("valTramForm:panelTabArbolTram");
