...
@Stateful
@Name("gestionArbolDeterminacionesBase")
public class GestionArbolDeterminacionesBaseBean extends GestionArbolGenerico
		implements Serializable, GestionArbolDeterminacionesBase {
	@Logger
	private Log log;
