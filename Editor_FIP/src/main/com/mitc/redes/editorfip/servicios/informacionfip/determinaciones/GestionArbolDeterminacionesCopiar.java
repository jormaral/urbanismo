...
*
* Licencia con arreglo a la EUPL, Version 1.1 o -en cuanto
...
@Local
public interface GestionArbolDeterminacionesCopiar extends GestionArbolGenericoIF{
	...
	/**
	 * Modifica el valor de la propiedad '@param nodoSeleccionado'
	 * 
	 * @param nodoSeleccionado valor de tipo 
	 */
