...
@Stateful
@Name("gestionArbolAsignacionTramite")
public class GestionArbolAsignacionTramiteBean extends GestionArbolGenerico implements Serializable, GestionArbolAsignacionTramite
{
