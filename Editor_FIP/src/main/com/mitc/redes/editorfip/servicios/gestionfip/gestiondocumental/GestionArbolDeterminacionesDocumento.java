...
/**
 * Este servicio se encarga de la gestión del arbol de asignacion de determinaciones al documento.
 * 
 * @author fguerrero
 *
 */
@Local
public interface GestionArbolDeterminacionesDocumento extends GestionArbolGenericoIF
{
	/**
	 * Método (evento) que guarda los datos de la determinación base.
