...
@Stateful
@Name("gestionArbolOperacionesEntidadesOperadas")
public class GestionArbolOperacionesEntidadesOperadasBean extends GestionArbolGenerico implements Serializable, GestionArbolOperacionesEntidadesOperadas
{
    /**
	 * 
	 */
