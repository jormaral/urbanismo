 ...
 */
public class ActionServletConfiguradorFichas extends HttpServlet {

    /**
	 * 
	 */
	private static final long serialVersionUID = 4505242047866044293L;

	private static final Logger log = Logger.getLogger(ActionServletConfiguradorFichas.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            if (usuario != null
                    && (usuario.tieneRol(TipoRol.FICHAS.getCodigo()))) {
                String wsName = request.getParameter("wsName");

                if (wsName != null) {
                	try {
	                    IAccion accion = (IAccion)icontext.lookup("java:global/UrbanismoEnRedV2/Urbanismoenred-ConsolaV2/"+wsName+"!es.mitc.redes.urbanismoenred.consola.ficha.IAccion");
