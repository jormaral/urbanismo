 ...
 *
 */
@Stateless(name="Unidades")
public class UnidadesHelper extends AbstractDeterminacionHelper implements IJsonHelper {
	...
	public Map<String, Object> marshal(Object id, String idioma) {
		...
		Determinacion determinacion = servicioPlaneamiento.getUnidad((Integer)id);
		
		if (determinacion != null) {
			lista.add(procesarDeterminacion(determinacion, 
