 ...
 *
 */
@Stateless(name = "DEL_DETERMINACION_GRUPO_FICHA")
public class BorrarDeterminacionGrupo implements IAccion {
    ...
    public void ejecutar(HttpServletRequest request,
        ...
        try {
            response.getWriter().print(servicioFichas.delDeterminacionGrupo( Long.parseLong(request.getParameter("idElemento"))));
