 ...
 *
 */
@Stateless(name = "DEL_DETERMINACION_CLASIF_ACTO")
public class BorrarDetClasifActo implements IAccion {
    ...
    public void ejecutar(HttpServletRequest request,
        ...
        try {
            response.getWriter().print(servicioFichas.delDeterminacionClasificatoriaActo( Long.parseLong(request.getParameter("idElemento"))));
