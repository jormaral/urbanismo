 ...
 *
 */
@Stateless(name="detUso")
public class DeterminacionUsoHelper implements IJsonHelper {
	...
	public Map<String, Object> marshal(Object id, String idioma) {
		...
		Determinacion[] determinaciones = servicioPlaneamiento.getDeterminacionesUsoEntidad((Integer)id);
