 ...
 *
 */
@Stateless(name="GET_VALORES_FICHA_DET_CLASIF_USO")
public class GetValoresDetClasifUso implements IAccion {
    ...
    public void ejecutar(HttpServletRequest request,
        ...
        if (determinacion != null && ficha != null) {
            ...
            try {
                ...
                Valoresclasifuso[] vals=servicioFichas.getValoresFromDetClasifUso(idFicha,idDeterminacion);

                for (Valoresclasifuso val : vals) {
                    ...
                    xtw.writeAttribute("tipo", "valordetclasfiuso");
