 ...
 *
 */
@Stateless(name="GET_NODOS_REGESP_HIJOS_RPM")
public class GetRegimenesEspecificosHijos implements IAccion {
	@EJB
	...
	public void ejecutar(HttpServletRequest request,
		...
		if (idEdr != null) {
			...
			try {
	            ...
	            for (Regimenespecifico reg : servicioPlaneamiento.getRegimenesEspecificosHijos(Integer.parseInt(idEdr))) {
