...
*/
package es.mitc.redes.urbanismoenred.consola.validacion;
...
public interface IAccion {
	static String CONTEXTOS_VALIDACION = "ContextosValidacion";
	/**
	 * Ejecuta una acción de validación dentro del contexto de ejecución de un 
	 * servlet o JSP.
	 * 
