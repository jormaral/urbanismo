 ...
 *
 */
@Stateless(name = "BAJAR_ELEMENTO_FICHA")
public class BajarElementoFicha implements IAccion {
    ...
    public void ejecutar(HttpServletRequest request,
        ...
        try {
            if ("determinacionregimenuso".equals(request.getParameter("tipo"))) {
                response.getWriter().print(servicioFichas.down(Regimenesuso.class, Long.valueOf(request.getParameter("idElemento"))));
            } else if ("determinacionregimenacto".equals(request.getParameter("tipo"))) {
                response.getWriter().print(servicioFichas.down(Regimenesacto.class, Long.valueOf(request.getParameter("idElemento"))));
            } else if ("valordetclasfiuso".equals(request.getParameter("tipo"))) {
                response.getWriter().print(servicioFichas.down(Valoresclasifuso.class, Long.valueOf(request.getParameter("idElemento"))));
            } else if ("valordetclasfiacto".equals(request.getParameter("tipo"))) {
                response.getWriter().print(servicioFichas.down(Valoresclasifacto.class, Long.valueOf(request.getParameter("idElemento"))));
            } else if ("grupo".equals(request.getParameter("tipo"))) {
                response.getWriter().print(servicioFichas.down(Conjuntodeterminaciongrupo.class, Long.valueOf(request.getParameter("idElemento"))));
            } else if ("conjuntogrupodeterminacion".equals(request.getParameter("tipo"))) {
                response.getWriter().print(servicioFichas.down(Grupodeterminaciondeterminacion.class, Long.valueOf(request.getParameter("idElemento"))));
            } else if ("conjuntogrupo".equals(request.getParameter("tipo"))) {
                response.getWriter().print(servicioFichas.down(Conjuntogrupo.class, Long.valueOf(request.getParameter("idElemento"))));
            } else if ("grupodeterminacion".equals(request.getParameter("tipo"))) {
                response.getWriter().print(servicioFichas.down(Grupodeterminacion.class, Long.valueOf(request.getParameter("idElemento"))));
            } else {
