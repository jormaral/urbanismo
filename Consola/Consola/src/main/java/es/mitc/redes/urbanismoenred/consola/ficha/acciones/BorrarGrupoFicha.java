 ...
 *
 */
@Stateless(name = "DEL_GRUPO_FICHA")
public class BorrarGrupoFicha implements IAccion {
    ...
    public void ejecutar(HttpServletRequest request,
        ...
        try {
            response.getWriter().print(servicioFichas.delGrupo( Long.parseLong(request.getParameter("idElemento"))));
