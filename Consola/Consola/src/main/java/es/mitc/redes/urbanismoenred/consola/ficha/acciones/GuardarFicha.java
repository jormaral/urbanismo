 ...
 *
 */
@Stateless(name = "GUARDAR_FICHA")
public class GuardarFicha implements IAccion {
    ...
    public void ejecutar(HttpServletRequest request,
        ...
        try {
            Ficha ficha = servicioFichas.guardarFicha(Integer.parseInt(request.getParameter("idTram")),
                    Integer.parseInt(request.getParameter("idFicha")),
                    request.getParameter("nombreFicha"),
                    request.getParameter("xPath"),
                    request.getParameter("ruta"));
            response.getWriter().print(ficha != null);
