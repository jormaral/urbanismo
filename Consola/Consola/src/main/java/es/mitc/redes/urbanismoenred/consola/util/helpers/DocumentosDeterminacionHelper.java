 ...
 *
 */
@Stateless(name="documentosDeterminacion")
public class DocumentosDeterminacionHelper implements IJsonHelper {
	...
	public Map<String, Object> marshal(Object id, String idioma) {
		...
		for (Documento documento : servicioPlaneamiento.getDocumentosDeterminacion((Integer)id)) {
