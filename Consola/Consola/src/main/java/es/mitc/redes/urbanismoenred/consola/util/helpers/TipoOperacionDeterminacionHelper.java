 ...
 *
 */
@Stateless(name="TipoOperacionDeterminacion")
public class TipoOperacionDeterminacionHelper implements IJsonHelper {
	...
	public Map<String, Object> marshal(Object id, String idioma) {
		...
		for (Tipooperaciondeterminacion tipo: servicioDiccionario.get(Tipooperaciondeterminacion.class)) {
			elemento = new HashMap<String, Object>();
			elemento.put("iden", tipo.getIden());
			elemento.put("nombre", servicioDiccionario.getTraduccion(Tipooperaciondeterminacion.class, tipo.getIden(), idioma));
			lista.add(elemento);
		}
