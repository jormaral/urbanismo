 ...
 *
 */
@Stateless(name = "GUARDAR_DET_CLASIF_FICHA")
public class GuardarDeterminacionClasificatoria implements IAccion {
    ...
    public void ejecutar(HttpServletRequest request,
        ...
        try {
            ...
            Determinacionclasifuso detClas = servicioFichas.guardarDetClasifUso(
                    Long.parseLong(request.getParameter("idFicha")),
                    Long.parseLong(request.getParameter("idDeterminacion"))
                    );
            response.getWriter().print(detClas != null);
        }else if ("acto".equals(request.getParameter("tipo"))){
            Determinacionclasifacto detClas = servicioFichas.guardarDetClasifActo(
                    Long.parseLong(request.getParameter("idFicha")),
                    Long.parseLong(request.getParameter("idDeterminacion"))
                    );
            response.getWriter().print(detClas != null);
