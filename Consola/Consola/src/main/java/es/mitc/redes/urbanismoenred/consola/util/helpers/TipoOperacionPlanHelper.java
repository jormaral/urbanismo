 ...
 *
 */
@Stateless(name="TipoOperacionPlan")
public class TipoOperacionPlanHelper implements IJsonHelper {
	...
	public Map<String, Object> marshal(Object id, String idioma) {
		...
		for (Tipooperacionplan tipo : servicioDiccionario.get(Tipooperacionplan.class)) {
