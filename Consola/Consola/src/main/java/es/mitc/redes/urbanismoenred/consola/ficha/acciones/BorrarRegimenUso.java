 ...
 *
 */
@Stateless(name = "DEL_DETERMINACION_REGIMEN_USO")
public class BorrarRegimenUso implements IAccion {
    ...
    public void ejecutar(HttpServletRequest request,
        ...
        try {
            response.getWriter().print(servicioFichas.delDeterminacionRegimenUso( Long.parseLong(request.getParameter("idElemento"))));
