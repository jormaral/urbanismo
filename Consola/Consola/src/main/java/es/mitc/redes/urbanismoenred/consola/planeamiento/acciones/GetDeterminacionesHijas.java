 ...
 *
 */
@Stateless(name="GET_NODOS_DETERM_DE_DETERM")
public class GetDeterminacionesHijas implements IAccion {
	...
	public void ejecutar(HttpServletRequest request,
		...
		if (idDet != null) {
			Determinacion[] determinaciones = servicioPlaneamiento.getDeterminacionesHijas(Integer.valueOf(idDet));
