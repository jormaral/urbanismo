 ...
 *
 */
@Stateless(name = "DEL_FICHA")
public class BorrarFicha implements IAccion {
    ...
    public void ejecutar(HttpServletRequest request,
        ...
        try {
            response.getWriter().print(servicioFichas.delFicha( Long.parseLong(request.getParameter("idFicha"))));
