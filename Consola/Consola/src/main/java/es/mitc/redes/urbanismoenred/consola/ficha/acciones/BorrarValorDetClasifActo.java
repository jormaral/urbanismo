 ...
 *
 */
@Stateless(name = "DEL_VALOR_DETERMINACION_CLASIF_ACTO")
public class BorrarValorDetClasifActo implements IAccion {
    ...
    public void ejecutar(HttpServletRequest request,
        ...
        try {
            response.getWriter().print(servicioFichas.delValorDetClasifActo( Long.parseLong(request.getParameter("idElemento"))));
