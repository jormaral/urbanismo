...
public class Planshp  implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5528517630614951120L;
	private int iden;
     private Plan plan;
     private String geom;
    ...
    public Planshp(int iden) {
        this.iden = iden;
   
    }
    public Planshp(int iden, Plan plan, String geom) {
       this.iden = iden;
       this.plan = plan;
       this.geom = geom;
    }
