 ...
 *
 */
@Stateless( name = "refundido.operacion.entidades.levantamientoTotalSuspension")
public class LevantamientoTotal implements EjecutorLocal {
	...
	public void ejecutar(int idOperada, int idOperadora,
		...
		contexto.logTraducido(LOG.INFO, "refundido.operacion.entidad.levantamientoTotal.mensaje", 
