 ...
 *
 */
@Stateless ( name = "refundido.operacion.entidades.superposicionCompleta")
public class SuperposicionCompleta extends CopiarEntidadDeterminacion implements EjecutorLocal {
	...
	public void ejecutar(int idOperada, int idOperadora,
		...
		contexto.logTraducido(LOG.INFO, "refundido.operacion.entidad.superposicionCompleta.mensaje", 
