 ...
 *
 */
@Stateless( name = "refundido.operacion.planes.levantamientoParcial")
public class RevocacionSuspensionParcial implements EjecutorLocal {
	...
	public void ejecutar(int idOperado, int idOperador,
		...
		contexto.logTraducido(LOG.INFO, "refundido.operacion.plan.levantamientoParcial.mensaje", operado.getCodigo(), operador.getCodigo());
	}
