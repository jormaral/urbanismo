...
/**
 * 
 * @author Arnaiz Consdultores
 *
 */
@Stateless ( name = "refundido.operacion.entidades.sustitucionGrafica")
public class SustitucionGrafica implements EjecutorLocal {
	...
	@EJB ( beanName = "refundido.operacion.entidades.destruccionGrafica")
	private EjecutorLocal destruccionGrafica;
	@EJB ( beanName = "refundido.operacion.entidades.creacionGrafica")
	private EjecutorLocal creacionGrafica;
	...
	public void ejecutar(int idOperada, int idOperadora,
		...
		contexto.logTraducido(LOG.INFO, "refundido.operacion.entidad.sustitucionGrafica.mensaje", 
		...
		if (operada != null && operadora != null) {
			if (!operadora.isBsuspendida()) {
				destruccionGrafica.ejecutar(idOperada, idOperadora, contexto);
				creacionGrafica.ejecutar(idOperada, idOperadora, contexto);
			} else {
