 ...
 *
 */
@Stateless( name = "refundido.operacion.entidades.superposicionNormasGenerales")
public class SuperposicionNormasGenerales extends CopiarEntidadDeterminacion implements EjecutorLocal {
	private static final List<Integer> CARACTERES = Arrays.asList(ClsDatos.ID_CARACTER_NORMAGENERALLITERAL, ClsDatos.ID_CARACTER_NORMAGENERALGRAFICA);
	...
	public void ejecutar(int idOperada, int idOperadora,
		...
		contexto.logTraducido(LOG.INFO, "refundido.operacion.entidad.superposicionNormasGenerales.mensaje", 
