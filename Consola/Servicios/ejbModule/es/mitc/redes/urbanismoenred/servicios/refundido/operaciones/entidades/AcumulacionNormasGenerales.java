 ...
 *
 */
@Stateless(name = "refundido.operacion.entidades.acumulacionNormasGenerales")
public class AcumulacionNormasGenerales extends CopiarEntidadDeterminacion implements EjecutorLocal {
	
	private static List<Integer> CARACTERES = Arrays.asList(ClsDatos.ID_CARACTER_NORMAGENERALLITERAL, ClsDatos.ID_CARACTER_NORMAGENERALGRAFICA);
	...
	public void ejecutar(int idOperada, int idOperadora,
		...
		contexto.logTraducido(LOG.INFO, "refundido.operacion.entidad.acumulacionNormasGenerales.mensaje", 
